...
@Import({SecurityConfig.class, TestOauthConfig.class})
class SubmissionControllerTest {
            ...
            get("/api/v1/submissions")
                .with(
                    jwt()
                        .jwt(
                            jwt ->
                                jwt.claim("providerUserId", "999e4567-e89b-12d3-a456-426614174999"))
  ...
  //   @Test
  //   void
  // getSubmissionsForProviderWithClTotals_returnsOkStatusAndAllSubmissionsForProviderWithTotals()
  //       throws Exception {
  ...
  //     verify(mockClaimService).updateSubmission(eq(submissionId),
  // any(SubmissionRequestBody.class));
  //   }

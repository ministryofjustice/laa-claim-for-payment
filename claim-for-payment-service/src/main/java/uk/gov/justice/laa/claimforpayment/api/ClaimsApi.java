...
public interface ClaimsApi {
     ...
     *
     * @param claimRequestBody create an claim (optional)
    ...
    ResponseEntity<Void> createClaim(
        @Parameter(name = "ClaimRequestBody", description = "create an claim") @Valid @RequestBody(required = false) @Nullable ClaimRequestBody claimRequestBody
    );
     ...
     * @param claimRequestBody update an existing claim (optional)
     * @return No content (status code 204)
     *         or Bad request (status code 400)
     *         or Unauthorized (status code 401)
     *         or Forbidden (status code 403)
    ...
    ResponseEntity<Void> updateClaim(
        ...
        @Parameter(name = "ClaimRequestBody", description = "update an existing claim") @Valid @RequestBody(required = false) @Nullable ClaimRequestBody claimRequestBody
    );

 ...
 *
 * <p>This annotation provides a centralized way to document the RFC 7807 Problem Details returned
 * by the API, including LAA-specific error codes and correlation IDs.
 */
